# master.py
# Bridge (telemetry_bridge.py) proxy portları:
#   14541 → Bridge → PX4:14581  (Drone 1, sysid=2)
#   14542 → Bridge → PX4:14582  (Drone 2, sysid=3)
#   14543 → Bridge → PX4:14583  (Drone 3, sysid=4)
#   14544 → Bridge → PX4:14584  (Drone 4, sysid=5)
#   14545 → Bridge → PX4:14585  (Drone 5, sysid=6)
#   14546 → Bridge → PX4:14586  (Drone 6, sysid=7)
#   14547 → Bridge → PX4:14587  (Drone 7, sysid=8)
# ÖNCE telemetry_bridge.py çalıştır, sonra master.py!
